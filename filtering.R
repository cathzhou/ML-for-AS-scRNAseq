...
data <- fread("/Users/catherinez/Research/ISMB/teich_IJC_SJC.csv")
data1 <- data[,-c(1:4)]
...
t.data <- t(datam)
write.csv(t.data, "/Users/catherinez/Research/ISMB/teich_IJC_SJC_t.csv")
...
write.csv(exonslist.f2.df, "/Users/catherinez/Research/ISMB/teich_IJC_SJC_filtered.csv")
...
write.csv(exons.psi.df, "/Users/catherinez/Research/ISMB/teich_psi_values_filtered_raw.csv")

#remove 0 variance exons
exons.psi.filter_var <- exons.psi.df[apply(exons.psi.df, 1, var) != 0, ]
write.csv(exons.psi.filter_var, "/Users/catherinez/Research/ISMB/teich_psi_values_filtered_var.csv")
...
write.csv(t.exons.psi.filter_var.m, "/Users/catherinez/Research/ISMB/teich_psi_values_filtered_var_t.csv")
...
write.csv(sumsubsm, "/Users/catherinez/Research/ISMB/teich_subset_sums.csv")
...
write.csv(sumtusm, "/Users/catherinez/Research/ISMB/teich_tumor_status_sums.csv")
